...
let searchM = async (search, num) => {
    try {
        ...
        let resww = await fetch(`https://api.themoviedb.org/3/search/movie?api_key=a8048c88841d1947ea18a343448e4679&language=en-US&include_adult=false&query=${search}&page=${num || 1}`)
